...
INLINE void mem_updatemap_rombank()
{
...
INLINE void mem_updatemap_vbank()
{
        mbc.rmap[0x8] = mbc.rmap[0x9] = lcd.vbank[R_VBK & 1] - 0x8000;
}

INLINE void mem_updatemap_sbank()
{
...
INLINE void mem_updatemap_ibank()
{
        int n = R_SVBK & 0x07;
